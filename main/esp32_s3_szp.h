...
#include <string.h>
// #include "esp_camera.h"       //这是一个组件，需要添加.yml文件
...
#define LCD_LEDC_CH          (LEDC_CHANNEL_0)      //LEDC_CHANNEL_0这个定义已经在ESP_IDF的组件中定义好了
...
#define BSP_LCD_PIXEL_CLOCK_HZ     (80 * 1000 * 1000)     //SPI的通信速率，定义为80M，为SPI的最大通信速率

#define LCD_CMD_BITS        (8)
#define LCD_PARAM_BITS       (8)
#define BSP_LCD_BITS_PER_PIXEL      (16)      //16位色深

#define BSP_LCD_H_RES              (320)      //液晶屏的宽和高
#define BSP_LCD_V_RES              (240)


#define BSP_LCD_DRAW_BUF_HEIGHT     22

#define BSP_LCD_SPI_NUM            (SPI3_HOST)   //SPI的外设号
...
#define CAMERA_PIN_SIOD 1        //SDA
#define CAMERA_PIN_SIOC 2        //SCL
...
#define XCLK_FREQ_HZ 20000000               //改成了GC0308的最大运行频率

void bsp_camera_init(const pixformat_t pixel_fromat,const framesize_t frame_size,const uint8_t fb_count);
